...
@dataclasses.dataclass(frozen=True)
class LeRobotSO101LWLabDataConfig(DataConfigFactory):
    action_sequence_keys: Sequence[str] = ("action",)
    ...
    def create(self, assets_dirs: pathlib.Path, model_config: _model.BaseModelConfig) -> DataConfig:
        ...
        repack_transform = _transforms.Group(
            inputs=[
                _transforms.RepackTransform(
                    {
                        "images/front": "observation.images.agentview_all",
                        "images/wrist": "observation.images.agentview_hand",
                        "state": "observation.state",
                        "actions": "action",
                        "prompt": "prompt",
                    }
...
_CONFIGS = [
    ...
    #
    # Fine-tuning LeRobot-SO101 configs.
    #
    TrainConfig(
        name="pi0_so101_pick_orange",
        model=pi0_config.Pi0Config(),
    ...
    TrainConfig(
        name="pi0_lora_so101_pick_orange",
        model=pi0_config.Pi0Config(paligemma_variant="gemma_2b_lora", action_expert_variant="gemma_300m_lora"),
        data=LeRobotSO101DataConfig(
            repo_id="EverNorif/leisaac-pick-orange",
            base_config=DataConfig(prompt_from_task=True),
    ...
    TrainConfig(
        name="pi0_fast_so101_pick_orange",
    ...
    TrainConfig(
        name="pi0_fast_lora_so101_pick_orange",
        model=pi0_fast.Pi0FASTConfig(action_dim=6, action_horizon=10, max_token_len=180, paligemma_variant="gemma_2b_lora"),
        data=LeRobotSO101DataConfig(
            repo_id="EverNorif/leisaac-pick-orange",
            base_config=DataConfig(prompt_from_task=True),
        ),
        weight_loader=weight_loaders.CheckpointWeightLoader("gs://openpi-assets/checkpoints/pi0_fast_base/params"),
        num_train_steps=30_000,
        freeze_filter=pi0_fast.Pi0FASTConfig(action_dim=6, action_horizon=10, max_token_len=180, paligemma_variant="gemma_2b_lora").get_freeze_filter(),
        ema_decay=None,
    ),
    TrainConfig(
        name="pi05_so101_pick_orange",
    ...
    TrainConfig(
        name="pi05_lora_so101_pick_orange",
    ...
    #
    # Fine-tuning LWLab SO101 configs.
    #
    TrainConfig(
        name="pi05_lwlab_so101_pick_orange",
        model=pi0_config.Pi0Config(pi05=True, action_horizon=10),
        data=LeRobotSO101LWLabDataConfig(
            repo_id="EverNorif/lwlab_so101_pick_orange",
            base_config=DataConfig(prompt_from_task=True),
        ),
        batch_size=128,
        weight_loader=weight_loaders.CheckpointWeightLoader("gs://openpi-assets/checkpoints/pi05_base/params"),
    ...
    TrainConfig(
        name="pi05_lora_lwlab_so101_pick_orange",
        model=pi0_config.Pi0Config(pi05=True, action_horizon=10, paligemma_variant="gemma_2b_lora", action_expert_variant="gemma_300m_lora"),
        data=LeRobotSO101LWLabDataConfig(
            repo_id="EverNorif/lwlab_so101_pick_orange",
            base_config=DataConfig(prompt_from_task=True),
